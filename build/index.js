 ...
 */
async function listNotesRecursively(dir, baseDir = VAULT_PATH) {
 ...
 */
server.tool("list_notes", "Lists all notes (.md files) in the vault recursively", {}, async () => {
    try {
 ...
 */
server.tool("read_note", "Reads the contents of a specific markdown note inside the vault", {
 ...
 */
server.tool("write_note", "Creates a new note or overwrites an existing note in the vault with the specified content", {
 ...
 */
server.tool("append_to_note", "Appends text/content to an existing note or creates it if it does not exist", {
 ...
 */
server.tool("search_notes", "Searches for a keyword or string inside all markdown notes in the vault", {
